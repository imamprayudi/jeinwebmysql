		...
		<section class="section">
			<div class="row">
				<div class="card card-info">
					<div class="card-body">
						<div id="section">
							<form method="post" action="jmnl_barcode_list.php" class="row gx-3 gy-2 align-items-center">
								<div class="col-7">
									<label class="col-form-label" for="suppcode">Supplier</label>
									<select class="form-select" name="suppcode" id="suppcode">
										<?php
										$rs_cb_suppcode = $db->Execute("select usersupp.UserId,usersupp.SuppCode,supplier.SuppName from UserSupp
												inner join Supplier on usersupp.SuppCode = Supplier.SuppCode
												where UserId = '" . $session_userid . "' order by suppname asc");
