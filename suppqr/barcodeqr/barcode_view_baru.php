			...
			if ($jml==1){
				if ($stdpack == $totalqty){
					...
					//	generate label
						...
						$tempDir 	= '../../printqr/stmp/';
						QRcode::png($barcode, $tempDir . $namafile, QR_ECLEVEL_L, 2);

						echo '<tr><td>';
						echo '<table border=1 cellspacing=0 width=300>';
							echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/stmp/' . $namafile . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
					...
					for ($i=1;$i<=$jml;$i++){
						...
						if($i % 2!=0){
							if (($totalqty - $kurang)>$sisa){
								...
								echo '<table border=1 cellspacing=0 width=300>';
									echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/stmp/' . $a . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
									echo '<tr> <td align=center><p>Customer</p></td> <td align=center colspan=2><p>PT.JVCKENWOOD ELECTRONICS INDONESIA</p></td> </tr>';
									echo '<tr> <td align=center><p>Part Name.</p></td> <td align=center><p>'.$partnm.'</p></td> <td rowspan=7 align=center valign=bottom><h2>'.$stsinsp.'</h2></td> </tr>';
									echo '<tr> <td align=center><p>Part No.</p></td> <td align=center><p><b>'.$partno.'</b></p></td> </tr>';
									echo '<tr> <td align=center><p>Material</p></td> <td align=center><p>'.$mtrl.'</p></td> </tr>';
						...
						if ($i % 2==0){
							...
							echo '<td align=right >';
							echo '<table border=1 cellspacing=0 width=300>';
								echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/stmp/' . $b_kanan1 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
								echo '<tr> <td align=center><p>Customer</p></td> <td align=center colspan=2><p>PT.JVCKENWOOD ELECTRONICS INDONESIA</p></td> </tr>';
								echo '<tr> <td align=center><p>Part Name.</p></td> <td align=center><p>'.$partnm.'</p></td> <td rowspan=7 align=center valign=bottom><h2>'.$stsinsp.'</h2></td> </tr>';
								echo '<tr> <td align=center><p>Part No.</p></td> <td align=center><p><b>'.$partno.'</b></p></td> </tr>';
								echo '<tr> <td align=center><p>Material</p></td> <td align=center><p>'.$mtrl.'</p></td> </tr>';
        ...
        default:
          ...
          // echo'<br>1) '. $jml.'=1<br>';
					if ($stdpack == $totalqty){
						...
						echo '<tr><td>';
						echo '<table border=1 cellspacing=0 width=300>';
							echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $namafile . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
							echo '<tr> <td align=center><p>Customer</p></td> <td align=center colspan=2><p>PT.JVCKENWOOD ELECTRONICS INDONESIA</p></td> </tr>';
							echo '<tr> <td align=center><p>Part Name.</p></td> <td align=center><p>'.$partnm.'</p></td> <td rowspan=7 align=center valign=bottom><h2>'.$stsinsp.'</h2></td> </tr>';
							echo '<tr> <td align=center><p>Part No.</p></td> <td align=center><p><b>'.$partno.'</b></p></td> </tr>';
							echo '<tr> <td align=center><p>Material</p></td> <td align=center><p>'.$mtrl.'</p></td> </tr>';
					...
					if(($i+1) % 6==0){
						//	soucrdb ( suppQR : P | ediweb : B | 48JEIN : I ) 
						  ...
						  // echo'<br>4.'.$i.'<br>';
							  ...
							  echo '<table border=1 cellspacing=0 width=300>';
							  echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $b1 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
						...
						//	soucrdb ( suppQR : P | ediweb : B | 48JEIN : I ) 
							...
							$unique22_2 		= $srcdb22_2 . $supp22_2 . $partno22_2 . $datetime22_2 . $printcode22_2;
							  ...
							  echo '<table border=1 cellspacing=0 width=300>';
							  echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $c1 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
						...
						//	soucrdb ( suppQR : P | ediweb : B | 48JEIN : I ) 
						  ...
						  echo '<table border=1 cellspacing=0 width=300>';
						  echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $d1 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
					}
						  echo '<tr> <td align=center><p>Customer</p></td> <td align=center colspan=2><p>PT.JVCKENWOOD ELECTRONICS INDONESIA</p></td> </tr>';
						  echo '<tr> <td align=center><p>Part Name.</p></td> <td align=center><p>'.$partnm.'</p></td> <td rowspan=7 align=center valign=bottom><h2>'.$stsinsp.'</h2></td> </tr>';
						  echo '<tr> <td align=center><p>Part No.</p></td> <td align=center><p><b>'.$partno.'</b></p></td> </tr>';
					...
					if($sisa==0){
					  // echo'<br>11) (sisa=0 '.$sisa.'=0 --- 8.'.$i.'<br>';
						...
						if(($i+1) % 6==0){
							...
							// echo'<br>5.'.$i.'<br>';
								...
								echo '<table border=1 cellspacing=0 width=300>';
									echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $b2 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
						}elseif($i % 3==0)	{
							//	soucrdb ( suppQR : P | ediweb : B | 48JEIN : I ) 
								$srcdb23_2	   		= 'P';
							...
							echo '<table border=1 cellspacing=0 width=300>';
							echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $c2 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
						}else{
							//	soucrdb ( suppQR : P | ediweb : B | 48JEIN : I ) 
								$srcdb23_3	   		= 'P';
						...
						//	generate label
							...
							echo '<table border=1 cellspacing=0 width=300>';
							echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $d2 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
						}
					  ...
					  // echo'<br>12) (sisa!=0 '.$sisa.'!=0 --- 9.'.$i.'<br>';
						...
						if(($i+1) % 6==0){
							...
							echo '<table border=1 cellspacing=0 width=300>';
								echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $namafile1 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
							...
							//	soucrdb ( suppQR : P | ediweb : B | 48JEIN : I ) 
								...
								$orderCodeDate24_2	= $date24_2 . $date_array24_2;
							...
							echo '<table border=1 cellspacing=0 width=300>';
							echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $namafile2 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
							...
							echo '<tr><td>';
								echo '<table border=1 cellspacing=0 width=300>';
									echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/prin/' . $namafile3 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
						}
			...
			echo '<table border=0 cellspacing=0 width=650>';
				if ($jml==1){
					if ($stdpack == $totalqty){
						...
						$tempDir 	= '../../printqr/wire/';
						QRcode::png($barcode, $tempDir . $namafile, QR_ECLEVEL_L, 2);

						echo '<tr><td>';
						echo '<table border=1 cellspacing=0 width=300>';
							echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/wire/' . $namafile . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
							echo '<tr> <td align=center><p>Customer</p></td> <td align=center colspan=2><p>PT.JVCKENWOOD ELECTRONICS INDONESIA</p></td> </tr>';
							echo '<tr> <td align=center><p>Part Name.</p></td> <td align=center><p>'.$partnm.'</p></td> <td rowspan=7 align=center valign=bottom><h2>'.$stsinsp.'</h2></td> </tr>';
							echo '<tr> <td align=center><p>Part No.</p></td> <td align=center><p><b>'.$partno.'</b></p></td> </tr>';
					...
					for ($i=1;$i<=$jml;$i++){
						...
						if($i % 2!=0){
							if (($totalqty - $kurang)>$sisa){
								...
								echo '<table border=1 cellspacing=0 width=300>';
									echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/wire/' . $a . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
									echo '<tr> <td align=center><p>Customer</p></td> <td align=center colspan=2><p>PT.JVCKENWOOD ELECTRONICS INDONESIA</p></td> </tr>';
									echo '<tr> <td align=center><p>Part Name.</p></td> <td align=center><p>'.$partnm.'</p></td> <td rowspan=7 align=center valign=bottom><h2>'.$stsinsp.'</h2></td> </tr>';
									echo '<tr> <td align=center><p>Part No.</p></td> <td align=center><p><b>'.$partno.'</b></p></td> </tr>';
									echo '<tr> <td align=center><p>Invoice No.</p></td> <td align=center><p>'.$invno.'</p></td> </tr>';
						...
						if ($i % 2==0){
							...
							echo '<td align=right >';
							echo '<table border=1 cellspacing=0 width=300>';
								echo '<tr> <td width=70 align=center><img style="max-height: 60px;" src="../../printqr/wire/' . $b_kanan4 . '" alt="gambar barcode" /></td> <td align=center><p><b>'.$suppname.'</b></p></td> <td width=70 align=center><p><b>RoHS <br> OK</b></p></td> </tr>';
								echo '<tr> <td align=center><p>Customer</p></td> <td align=center colspan=2><p>PT.JVCKENWOOD ELECTRONICS INDONESIA</p></td> </tr>';
								echo '<tr> <td align=center><p>Part Name.</p></td> <td align=center><p>'.$partnm.'</p></td> <td rowspan=7 align=center valign=bottom><h2>'.$stsinsp.'</h2></td> </tr>';
								echo '<tr> <td align=center><p>Part No.</p></td> <td align=center><p><b>'.$partno.'</b></p></td> </tr>';
								echo '<tr> <td align=center><p>Invoice No.</p></td> <td align=center><p>'.$invno.'</p></td> </tr>';
