  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        $rscek = $db->Execute("select blnthn,suppcode,suppcom,jeincom from soacom where 
  blnthn = '" . $blnthn . "' and suppcode = '" . $supp . "'");
        $ada = $rscek->RecordCount();
        if ($ada == 0) {
          $sql = "insert into soacom(blnthn,suppcode," . $yangkomen . ") values('" . $blnthn . "','" . $supp . "','" . $komentar . "')";
        } else {
          $sql = "update soacom set " . $yangkomen . " ='" . $komentar . "' where 
  blnthn ='" . $blnthn . "' and suppcode ='" . $supp . "'";
        }
