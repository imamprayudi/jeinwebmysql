...
<head>
  ...
  <script type="text/javascript">
    function ShowBps(supp, tgl) {
      ...
      xmlhttp.open("GET", "jgetsoa.php?supp=" + supp + "&tgl=" + tgl, true);
      xmlhttp.send();
...
where UserId = '" . $myid . "' order by suppname");
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Statement of Account - Detail</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../contents_v2/index.php">Home</a></li>
          <li class="breadcrumb-item"><a href="#">Statement of Account</a></li>
      ...
      <div class="row">
        ...
        echo '<br /><br />'; -->
            <form action="" class="row gx-3 gy-2 align-items-center">
              ...
              <?php
              // $rs = $db->Execute("select distinct transdate from soa order by transdate desc");
