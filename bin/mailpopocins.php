<?php
	...
	*/  
    ...
    $rs = $db->Execute("insert into mailpost(transdate,supplier,updated) 
      select distinct rdate,supplier,(concat(rdate,' ',rtime)) from mailpotoday;");
    $rs->Close();
    echo 'Insert into mailpost success<br />';

    // insert data to mailpocst from mailpoctoday
    $rs = $db->Execute("insert into mailpocst(transdate,supplier,updated) 
      select distinct rdate,supplier,(concat(rdate,' ',rtime)) from mailpoctoday;");
    $rs->Close();
